...
export const sectionTypes: SectionDefinition[] = [
  ...
  },
  {
    ...
    defaultContent: `<p style="margin: 0; margin-bottom: 0px;"><a th:href="\${ctaUrl}" href="#" style="font-size: 14px; color: #5A469B; font-family: ${OUTLOOK_FONT_FAMILY}; line-height: 24px; font-weight: bold; text-decoration: none;"><span th:utext="\${ctaText}"/></a></p>`,
    category: 'interactive',
    variables: [
