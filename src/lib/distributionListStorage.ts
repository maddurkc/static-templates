...
const STORAGE_KEY = "smart_distribution_lists_v5";
...
function seedDemoLists(): DistributionList[] {
  ...
  return [
    ...
    mk(
      "dl-demo-allhands",
      "AllHands",
      "Company-wide all-hands distribution with full leadership coverage",
      "PUBLIC",
      [
        ...
        "rob.garcia@company.com",
        "nancy.thompson@company.com",
        "james.white@company.com",
        "karen.lee@company.com",
        "david.clark@company.com",
        "patricia.hall@company.com",
        "mark.lewis@company.com",
        "susan.young@company.com",
        "brian.king@company.com",
        "laura.wright@company.com",
        "steve.allen@company.com",
        "jessica.scott@company.com",
        "andrew.green@company.com",
        "mary.adams@company.com",
        "joseph.baker@company.com",
      ].join(", "),
      [
        "john.doe@company.com",
        "jane.smith@company.com",
      ...
      [
        toSharedRef(MOCK_USER_DIRECTORY[0]),
        toSharedRef(MOCK_USER_DIRECTORY[1]),
        toSharedRef(MOCK_USER_DIRECTORY[2]),
        toSharedRef(MOCK_USER_DIRECTORY[3]),
        toSharedRef(MOCK_USER_DIRECTORY[4]),
        toSharedRef(MOCK_USER_DIRECTORY[5]),
        toSharedRef(MOCK_USER_DIRECTORY[6]),
        toSharedRef(MOCK_USER_DIRECTORY[7]),
        toSharedRef(MOCK_USER_DIRECTORY[8]),
        toSharedRef(MOCK_USER_DIRECTORY[9]),
        toSharedRef(MOCK_USER_DIRECTORY[10]),
        toSharedRef(MOCK_USER_DIRECTORY[11]),
        toSharedRef(MOCK_USER_DIRECTORY[12]),
        toSharedRef(MOCK_USER_DIRECTORY[13]),
        toSharedRef(MOCK_USER_DIRECTORY[14]),
      ],
    ),
  ];
}
...
const MOCK_USER_DIRECTORY: DirectoryUser[] = [
  ...
  { id: "u-11", elid: "E10011", lanid: "rgarcia",    name: "Rob Garcia",       email: "rob.garcia@company.com",      department: "Engineering" },
  { id: "u-12", elid: "E10012", lanid: "nthompson",  name: "Nancy Thompson",   email: "nancy.thompson@company.com",  department: "Operations" },
  { id: "u-13", elid: "E10013", lanid: "jwhite",     name: "James White",      email: "james.white@company.com",     department: "IT" },
  { id: "u-14", elid: "E10014", lanid: "klee",       name: "Karen Lee",        email: "karen.lee@company.com",       department: "Finance" },
  { id: "u-15", elid: "E10015", lanid: "dclark",     name: "David Clark",      email: "david.clark@company.com",     department: "Sales" },
  { id: "u-16", elid: "E10016", lanid: "phall",      name: "Patricia Hall",    email: "patricia.hall@company.com",   department: "HR" },
  { id: "u-17", elid: "E10017", lanid: "mlewis",     name: "Mark Lewis",       email: "mark.lewis@company.com",      department: "Marketing" },
  { id: "u-18", elid: "E10018", lanid: "syoung",     name: "Susan Young",      email: "susan.young@company.com",     department: "Design" },
  { id: "u-19", elid: "E10019", lanid: "bking",      name: "Brian King",       email: "brian.king@company.com",      department: "Product" },
  { id: "u-20", elid: "E10020", lanid: "lwright",    name: "Laura Wright",     email: "laura.wright@company.com",    department: "Legal" },
  { id: "u-21", elid: "E10021", lanid: "sallen",     name: "Steve Allen",      email: "steve.allen@company.com",     department: "Engineering" },
  { id: "u-22", elid: "E10022", lanid: "jscott",     name: "Jessica Scott",    email: "jessica.scott@company.com",   department: "Operations" },
  { id: "u-23", elid: "E10023", lanid: "agreen",     name: "Andrew Green",     email: "andrew.green@company.com",    department: "IT" },
  { id: "u-24", elid: "E10024", lanid: "madams",     name: "Mary Adams",       email: "mary.adams@company.com",      department: "Finance" },
  { id: "u-25", elid: "E10025", lanid: "jbaker",     name: "Joseph Baker",     email: "joseph.baker@company.com",    department: "Sales" },
];
