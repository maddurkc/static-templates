import { Layers, FileText, PlayCircle, Database, Network, FileCode, Settings, Users } from "lucide-react";
...
const menuItems = [
  ...
  { title: "Distribution Lists", url: "/distribution-lists", icon: Users },
